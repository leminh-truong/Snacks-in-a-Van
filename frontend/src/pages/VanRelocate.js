...
function VanRelocate() {
    ...
    return (
        ...
        {isLoading ? <Loading /> :
            <div>
                <p className="welcome">Relocate Van</p>
                <h1 className="welcomeTitle">Let's pick your next location</h1>
                ...
                {isVanOpenDialog && <Popup noCloseButton={true} content={
                    <div>
                        ...
                        <p className="popupHeader">You're not open!</p>
                        <button className="centeredButton" onClick={() => history.push("/van/open")}>Go open up!</button>
                    </div>
                } />}
            </div>
        }
